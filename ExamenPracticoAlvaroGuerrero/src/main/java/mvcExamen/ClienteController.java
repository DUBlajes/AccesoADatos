...
public class ClienteController {
    ...
    public void mostrarClientes() throws SQLException {
        List<Videojuego> videojuegos = model.getAllVideojuegos();// Obtiene la lista de clientes desde el modelo
        view.mostrarProductos(videojuegos); // Muestra los clientes en la vista
    }
